...
public class Player : MonoBehaviour
{
    ...
    // This is the maximum number of bullets that the player needs to fire before reloading.
    public int mMaxAmunitionBeforeReload = 40;
    // This is the total number of bullets that the player has.
    [HideInInspector]
    ...
    public void Aim()
    {
        ...
        // if (intersected)
        // {
        //     Draw a line as debug to show the aim of 
        //     fire in the scene view.
        //
        //     Find the transformed intersected point to screenspace
        //     and then transform the crosshair position to this
        //     new position.
        //     
        //     Enable or set active the crosshair game object.
        // }
        // else
        // {
        //     // Hide or set inactive the crosshair game object.
        // }
        //-----------------------------------------------------------------//
        ...
        // Do the Raycast
        RaycastHit hit;
        bool flag = Physics.Raycast(gunpoint, dir, out hit, 50.0f, objectsMask);

        if (flag)
        {
            //     Draw a line as debug to show the aim of fire in the scene view.
